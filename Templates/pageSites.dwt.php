  ...
  <footer style="background-color:[colorFooter];color:[colorFooterText]">
    ...
    <div style="text-align: center;padding-bottom:0px">
    	<table style=" margin: 0 auto;" border="0">
          <tbody>
            <tr>
              <td><a href="#"><img src="../pages/img/home.png" width="40" height="40" alt="Pagina Principal"/></a></td>
              <td><a href="#"><img src="../pages/img/facebook.png" width="40" height="40" alt="Facebook"/></a></td>
              <td><a href="#"><img src="../pages/img/twiter.png" width="40" height="40" alt="Twiter"/></a></td>
              <td><a href="#"><img src="../pages/img/youtube.png" width="40" height="40" alt="YouTube"/></a></td>
              <td>&nbsp;</td>
            </tr>
          </tbody>
        </table>
