...
<!--content -->
		<article id="content"><div class="ic">More Website Templates @ TemplateMonster.com - November 14, 2011!</div>
			  <!-- TemplateBeginEditable name="principalEditable" -->
			  <h3>Contenido Principal</h3>
	    <!-- TemplateEndEditable --></article>
	  </div>
		<div class="bg1">
			<div class="main">
				<article id="content2">
					<div class="wrapper"><!-- TemplateBeginEditable name="otroContenido" -->
					  <h3>Contenido Editable inferior</h3>
