...
<!--content -->
		<article id="content"><div class="ic">More Website Templates @ TemplateMonster.com - November 14, 2011!</div>
			  <!-- InstanceBeginEditable name="PrimerContenido" -->
			  	<div class="wrapper">
					<h2>Nueva Empresa</h2>
					<form id="ContactForm" action="php/grabar.php" method="post">
						<div>
							<div  class="wrapper">
								<span>Nombre:</span>
								<div class="bg"><input name="nombre" type="text" class="input" id="nombre" ></div>
							</div>
							<div  class="wrapper">
								<span>Direccion:</span>
								<div class="bg"><input name="direccion" type="text" class="input" id="direccion" ></div>								
							</div>
                            <div  class="wrapper">
								<span>Telefonos:</span>
								<div class="bg"><input name="telefonos" type="text" class="input" id="telefonos" ></div>								
							</div>
							<div  class="wrapper">
								<span>Email:</span>
								<div class="bg"><input name="email" type="text" class="input" id="email" ></div>								
							</div>
							<div  class="textarea_box">
								<span>Descripcion:</span>
								<div class="bg"><textarea name="descripcion" cols="1" rows="1" id="descripcion"></textarea></div>								
							</div>
							<a href="#" class="button1" onClick="document.getElementById('ContactForm').submit()">Guardar</a>
