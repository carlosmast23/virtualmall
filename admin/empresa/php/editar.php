...
class Controlador extends ControladorAccion
{
    ...
    public function ejecutar() 
    {
        //echo $_REQUEST[1];
        $empresa=new Empresa();
        $empresa->llenarConArray($_REQUEST);
        $servicioEmpresa=new EmpresaServicio();
        $servicioEmpresa->editar($empresa);
        
        $this->mensaje("Empresa Editada",
                "Los datos fueron editados exitosamente , en unos momentos le redireccionamos al menu de empresas", 
