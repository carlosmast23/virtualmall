...
<!--header -->
			<header>
				...
				<nav>
					<ul id="menu">
						<li class="active"><a href="indexVista.php.html"><span>[Homepage]</span></a></li>
...
<!--content -->
			<article id="content"><div class="ic">More Website Templates @ TemplateMonster.com - November 14, 2011!</div>
				<div class="wrapper">
					...
					<div class="col1 marg_right1">
						<h2>Analysis</h2>
						<p>This website template has sev- eral pages: <a href="indexVista.php.html">Home</a>, <a href="Company.html">Company</a>, <a href="Solutions.html">Solutions</a>, <a href="Services.html">Services</a>, <a href="Contacts.html">Contact Us</a> (contact form – doesn’t work).</p>
					</div>
					<div class="col1 marg_right1">
						<h2>Strategy</h2>
